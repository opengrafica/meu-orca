...
const navItems = [
  ...
  { to: '/admin/users', label: 'Usuários', icon: UserCircle },
  { to: '/admin/clients', label: 'Todos os Clientes', icon: Users },
  { to: '/admin/quotes', label: 'Todas as Vendas', icon: FileText },
]
    ...
    <div className="flex min-h-svh">
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-14 items-center border-b px-4 md:hidden">
          ...
          <span className="ml-3 text-lg font-bold">Admin MeuOrça</span>
        </header>
